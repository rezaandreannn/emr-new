    ...
    public function update()
    {
        ...
        if ($this->form_validation->run() !== false) {
                ...
                try {
                   ...
                   $this->Rawat_jalan_model->update_status_rj($status_rj);
                   ...
                   $this->Rawat_jalan_model->update_vital_sign($vital_sign);
                   // end insert vital sign
                   //insert nyeri
                   $nyeri = array(
                    $this->input->post('FS_NYERIP'),
                   ...
                   $this->Rawat_jalan_model->update_nyeri($nyeri);
                   //end insert nyeri
                   //resiko jatuh
                   $resiko_jatuh = array(
                       $this->input->post('FS_CARA_BERJALAN1'),
                   ...
                   $this->Rawat_jalan_model->update_resiko_jatuh($resiko_jatuh);
                   ...
                   $this->Rawat_jalan_model->update_asesmen_perawat($asasmen_perawat);
                   ...
                   $this->Rawat_jalan_model->update_nutrisi($nutrisi);
                   ...
                   $riwayat = array(
                    ...
                    $this->input->post('FS_NUTRISI_ANAK1_0') ? $this->input->post('FS_NUTRISI_ANAK1_0') : '',
                ...
                $this->Rawat_jalan_model->insert_riwayat_perawat($riwayat);

                
                $masalah_kep = $this->input->post('tujuan');
                $this->Rawat_jalan_model->delete_masalah_kep($this->input->post('FS_KD_REG'));
                   if (!empty($masalah_kep)) {
                       foreach ($masalah_kep as $value) {
                           $this->Rawat_jalan_model->insert_masalah_kep(array($this->input->post('FS_KD_REG'), $value));
                       }
                   ...
                   $rencana_kep = $this->input->post('tembusan');
                   $this->Rawat_jalan_model->delete_rencana_kep($this->input->post('FS_KD_REG'));
                   if (!empty($rencana_kep)) {
                       foreach ($rencana_kep as $value) {
                           $this->Rawat_jalan_model->insert_rencana_kep(array($this->input->post('FS_KD_REG'), $value));
                       }
