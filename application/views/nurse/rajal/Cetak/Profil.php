    ...
    <center>
        ...
        <table width="100%" style="border: none">
            <tr>
                ...
                <td width="100" class="text1">: <?= ucwords(strtolower($rs_pasien['NAMA_PASIEN'])); ?></td>
                <td width="100" class="text1">No MR</td>
                <td width="100" class="text1">: <?= $rs_pasien['NO_MR'] ?></td>
            </tr>
            <tr>
                <td width="100" class="text1">Tanggal Lahir</td>
                <td width="100" class="text1">: <?php echo date('d-M-Y', strtotime($rs_pasien['TGL_LAHIR'])); ?> </td>
                <td width="100" class="text1">Alamat</td>
                <td width="100" class="text1">: <?php echo $rs_pasien['ALAMAT'] . "," . $rs_pasien['KOTA']; ?></td>
            </tr>
            <tr>
