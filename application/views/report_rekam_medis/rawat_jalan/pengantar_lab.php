  ...
  <center>
    ...
    <table width="100%">
      ...
      <tr>
        ...
        <td width="180">: <?php foreach ($pemeriksaan_lab as $lab) {
                            echo $lab['JENIS'] . ",";
                          } ?></td>
      </tr>
    </table>
    ...
    <table width="100%" style="text-align:right">
      ...
      <tr>
        <td width="430"></td>
        <td>
          <qrcode value="<?= $medis_by_noreg['NAMA_DOKTER']; ?> pada <?= $medis_by_noreg['mdd']; ?>" ec="H" style="width: 15mm; background-color: white; color: black;"></qrcode>
        </td>
      </tr>
      <tr>
        <td width="430"></td>
