    ...
    <div class="container-fluid">
        ...
        <div class="card card-secondary">            
            <div class="card-header card-success">
                <h3 class="card-title">Form Tanda Tangan Pasien</h3>
            ...
            <!-- include form -->
            <form action="<?php echo base_url('fisioterapi/store_ttd_pasien'); ?>" method="post">
                <div class="card-body">
                <div class="col-md-12">
                <input type="hidden" name="NO_MR" value="<?= $mr ?>" />
